...
const bla = async () => {
  var x = await _DataController2.default.hotel.getOne(20);
  console.log(x);
};
...
var _SearchMain = __webpack_require__(60);
...
var _Jumbotron = __webpack_require__(61);
...
class SearchMain extends _react2.default.Component {
  ...
  render() {
    return _react2.default.createElement(
      ...
      null,
      _react2.default.createElement(_Jumbotron2.default, { getAll: this.getAllAndPushToCardHolder })
    );
  }
}
...
class Jumbotron extends _react2.default.Component {
	render() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(_SearchForm2.default, { className: "jumbotron__form", getAll: this.props.getAll.bind(this) })
		);
	}
}
