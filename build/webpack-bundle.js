...
var _DataController = __webpack_require__(27);
...
const bla = (() => {
  var _ref = _asyncToGenerator(function* () {
    var x = yield _DataController2.default.hotel.getOne(20);
    console.log(x);
  });
...
*/
var ba=__webpack_require__(0),m=__webpack_require__(18),A=__webpack_require__(6),C=__webpack_require__(5),ea=__webpack_require__(19),fa=__webpack_require__(20),ha=__webpack_require__(21),ja=__webpack_require__(9);
...
var _SearchMain = __webpack_require__(64);
...
var _CardHolder = __webpack_require__(68);

var _CardHolder2 = _interopRequireDefault(_CardHolder);

var _SearchForm = __webpack_require__(67);
...
class SearchMain extends _react2.default.Component {
  ...
  getAllAndPushToCardHolder() {
    var _this = this;

    return _asyncToGenerator(function* () {
      console.log("the correct one :)");
      const data = yield _DataController2.default.hotel.getAll();
      _this.setHotels(data);
    })();
  }

  getHotelsByLocation(lat, lng) {
    var _this2 = this;

    return _asyncToGenerator(function* () {
      console.log("blabla");
      const data = yield _DataController2.default.hotel.getHotelsByLocation(lat, lng);
      _this2.setHotels(data);
    })();
  }
